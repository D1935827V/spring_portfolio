...
|**[MiniLab5: greyscale](...)**|**Calvin**|**Implemented greyscale, currrent issue is with implementing greyscale for multiple imgs.\nDroped MiniLab 5 after switch to algo extend lab, now constructing algorithim extend lab**|
