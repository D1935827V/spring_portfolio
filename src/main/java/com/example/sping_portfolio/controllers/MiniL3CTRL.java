...
public class MiniL3CTRL {
    @GetMapping("/MiniLab3")    // CONTROLLER handles GET request for /greeting, maps it to greeting() and does variable bindings
    public String Calculator(@RequestParam(name="num1", required=false, defaultValue= "0") int num1, @RequestParam(name="num2", required=false, defaultValue="0") int num2, Model model) {
        ...
        return "MiniL3CTRL"; // returns HTML VIEW (greeting)
    }
}